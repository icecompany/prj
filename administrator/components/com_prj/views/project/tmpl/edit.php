...
HTMLHelper::_('script', 'com_prj/project.js', array('version' => 'auto', 'relative' => true));
?>
    ...
    <div class="row-fluid">
        <div class="span12 form-horizontal">
            ...
            <div class="tab-content">
                <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::sprintf('COM_PRJ_TAB_PROJECT_GENERAL')); ?>
                <div class="row-fluid">
                    <div class="span6">
